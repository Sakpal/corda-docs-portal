...
You can see a complete list, and guidance on monitoring specific scenarios in the [Monitoring scenarios docs]({{< relref "../../node/operating/monitoring-and-logging/monitoring-scenarios.md" >}}).
