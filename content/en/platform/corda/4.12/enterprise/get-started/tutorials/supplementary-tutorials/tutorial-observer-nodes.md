...
menu:
  corda-enterprise-4-12:
    identifier: corda-enterprise-4-12-tutorial-observer-nodes
...
participant/owner. See the Example usage section of the [API: Vault Query]({{< relref "../../../cordapps/api-vault-query.md" >}}) page for information on how to do this.
