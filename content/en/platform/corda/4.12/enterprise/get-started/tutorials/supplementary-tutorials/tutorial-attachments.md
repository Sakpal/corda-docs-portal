...
menu:
  corda-enterprise-4-12:
    identifier: corda-enterprise-4-12-tutorial-attachments
...
To upload an attachment to the node, you need to first connect to the relevant node. You can do this via the Corda RPC Client, as described in [Interacting with a node]({{< relref "../../../node/operating/clientrpc.md" >}}) or you can upload your attachment via the [Node shell]({{< relref "../../../node/operating/shell.md" >}}).
...
Attachment metadata can be queried in a similar way to the vault (see [API: Vault Query]({{< relref "../../../cordapps/api-vault-query.md" >}})).
