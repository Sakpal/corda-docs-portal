...
menu:
  corda-enterprise-4-12:
    parent: corda-enterprise-4-12-notary-migration-overview
    identifier: corda-enterprise-4-12-upgrade-notary-database
...
see the [JPA Notary Setup]({{< relref "ha-notary-service-overview.md" >}}) and [Notary Worker Configuration](installing-the-notary-service.md/) documentation.
