...
{{< warning >}}
Before upgrading, make sure the platform database schema is properly migrated and the changelog synchronized - consult the [upgrade documentation for Corda Enterprise Edition 4.11]({{< relref "../app-upgrade-notes.md" >}}). If you have not migrated the schema, the Tokens SDK may not upgrade correctly.
{{< /warning >}}
