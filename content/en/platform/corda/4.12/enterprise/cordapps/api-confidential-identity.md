...
menu:
  corda-enterprise-4-12:
    parent: corda-enterprise-4-12-cordapps-identity
tags:
- api
- confidential
- identity
...
You can see an example of using `SwapIdentitiesFlow` in [TwoPartyDealFlow.kt](../../../../../../en/api-ref/corda/4.11/community/kotlin/corda/net.corda.finance.flows/-two-party-deal-flow/index.html).
