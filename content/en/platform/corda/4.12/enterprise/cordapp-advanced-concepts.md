...
menu:
  corda-enterprise-4-12:
    identifier: corda-enterprise-4-12-cordapp-advanced-concepts
...
The recommended solution for CorDapp to CorDapp dependency is to always manually attach the dependent CorDapp to the transaction. See [Code samples for dependent libraries and CorDapps](#code-samples-for-dependent-libraries-and-cordapps).
