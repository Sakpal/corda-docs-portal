...
menu:
  corda-community-4-12:
    identifier: corda-community-4-12-reissuing-states
...
See [Encumbrances]({{< relref "key-concepts-contracts.md#encumbrances" >}}) for more information.
{{< /note >}}
...
{{< note >}}
This functionality is part of Corda Open Source and can be fully leveraged by Corda Enterprise Edition users as well.
{{< /note >}}
...
State machine [CDL]({{< relref "../../../../tools/cdl/cdl-overview.md" >}}) chart:
