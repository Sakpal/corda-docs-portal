...
menu:
  corda-community-4-12:
    identifier: corda-community-4-12-deploying-a-node
...
4. Download the [Corda jar](https://download.corda.net/maven/corda-releases/net/corda/corda/4.12/corda-4.12.jar)
(under `/4.12/corda-4.12.jar`) and place it in `/opt/corda`.
