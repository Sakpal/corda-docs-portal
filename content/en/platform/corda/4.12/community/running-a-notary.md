...
done automatically when creating the network, if using [Network Bootstrapper]({{< relref "network-bootstrapper.md" >}}). See [Networks]({{< relref "corda-networks-index.md" >}})
for more details.
...
try it out on our [notary demo](https://github.com/corda/corda/blob/release/os/4.12/samples/notary-demo) page. Note that it
