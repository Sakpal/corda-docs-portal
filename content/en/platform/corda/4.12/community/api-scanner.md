...
menu:
  corda-community-4-12:
    identifier: corda-community-4-12-api-scanner
...
new Corda release. The stable Corda modules are listed [here]({{< relref "api-stability-guarantees.md" >}}). Our CI process runs an “API Stability”
...
or anything in a module that isn’t in the stable modules list [here]({{< relref "api-stability-guarantees.md" >}}).
