...
menu:
  corda-community-4-12:
    identifier: corda-community-4-12-tutorial-basic-cordapp-state
...
If you don't know how to open a CorDapp in IntelliJ, see the documentation on [Running a sample CorDapp]({{< relref "../../../tutorial-cordapp.md#step-2-open-the-sample-cordapp-in-intellij-idea" >}}).
...
The next line of code you add defines the type of [ContractState]({{< relref "../../../api-states.md#contractstate-sub-interfaces" >}}) you implement with the `AppleStamp` class. Add this line to ensure that Corda recognizes the `AppleStamp` as a state.
